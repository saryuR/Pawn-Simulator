...
GLOBALS.COMMAND_TIPS[COMMAND_DICT.PLACE] =
  'This command is must before any other Command. It places the Pawn on board. Valid directions are WEST, NORTH, EAST, SOUTH. Example Input: PLACE 0 0 NORTH';
GLOBALS.COMMAND_TIPS[COMMAND_DICT.LEFT] =
  'This command only change the direction of the Pawn to anti clockwise';
GLOBALS.COMMAND_TIPS[COMMAND_DICT.RIGHT] =
  'This command only change the direction of the Pawn to  clockwise';
...
GLOBALS.COMMAND_TIPS[COMMAND_DICT.REPORT] =
  'This will report the current position and direction of Pawn';
...
GLOBALS.SYS_MSG[COMMAND_DICT.NOT_VALID] =
  'Curvetomorrow, This Pawn is sensitive about its Command Manual. Look at below For Commands';
GLOBALS.SYS_MSG[GLOBALS.PLACEMENT_CONSTRAINT] =
  'This Pawn needs a placement first';
